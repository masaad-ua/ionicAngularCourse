    ...
    return this.authService.token.pipe(
      ...
      switchMap(token => {
        return this.http.get<{ [key: string]: PlaceData }>(
          `https:///ionic-angular-course-70bcb-default-rtdb.europe-west1.firebasedatabase.app/offered-places.json?auth=${token}`
        );
      }),
      map(resData => {
        const places = [];
    ...
    return this.authService.token.pipe(
      ...
      switchMap(token => {
        return this.http.get<PlaceData>(
          `https:///ionic-angular-course-70bcb-default-rtdb.europe-west1.firebasedatabase.app/offered-places/${id}.json?auth=${token}`
        );
      }),
      map(placeData => {
        return new Place(
    ...
    return this.authService.token.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https:///ionic-angular-course-70bcb-default-rtdb.europe-west1.firebasedatabase.app/offered-places/${placeId}.json?auth=${fetchedToken}`,
